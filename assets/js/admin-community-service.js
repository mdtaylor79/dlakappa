window.CommunityService = (function () {
  ...
  function renderTypeChart() {
    ...
    chartType = new Chart(ctx, {
      type: "doughnut",
      data: { labels: ["Internal", "External"], datasets: [{ data: [internal, external], backgroundColor: ["#5c1a2b", "#c9a961"] }] },
  ...
  function renderLocationsChart() {
    ...
    chartLocations = new Chart(ctx, {
      type: "bar",
      data: { labels: top.map((t) => t[0]), datasets: [{ label: "Hours", data: top.map((t) => t[1]), backgroundColor: "#c9a961" }] },
